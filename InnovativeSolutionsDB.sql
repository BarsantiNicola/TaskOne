...
INSERT INTO `users` VALUES ('HAdministrator','admin','admin@example.com','admin','adminPassword','admin','Administrator',10000,NULL),('HCustomer','adri','adri@example.com','Adrienne','adriPassword','Andrews',NULL,NULL,NULL),('HHeadDepartment','adrian','adrian@example.com','Adrian','adrianPassword','Robinson','Engineer',3000,NULL),('HEmployee','agatha','agatha@example.com','Agatha','agathaPassword','Lane','Janitor',1200,NULL),('HCustomer','amy','amy@example.com','Amy','amyPassword','Lowe',NULL,NULL,NULL),('HCustomer','anto83','anto83@example.com','Anthony','anto83Password','Griffin',NULL,NULL,NULL),('HCustomer','betty','betty@example.com','Betty','bettyPassword','Jordan',NULL,NULL,NULL),('HTeamedEmployee','bob','bob@example.com','Robert','bobPassword','Caldwell','Technician',1800,1),('HCustomer','brad','brad@example.com','Bradley','bradPassword','Proctor',NULL,NULL,NULL),('HTeamedEmployee','christopher','christopher@example.com','Christopher','christopherPassword','Austin','Technician',1800,4),('HCustomer','Dani','Dani@example.com','Danielle','DaniPassword','Johnson',NULL,NULL,NULL),('HCustomer','david91','david91@example.com','David','david91Password','Baldwin',NULL,NULL,NULL),('HCustomer','Dia','Dia@example.com','Diana','DiaPassword','Williams',NULL,NULL,NULL),('HCustomer','donny','donny@example.com','Donny','donnyPassword','Hudson',NULL,NULL,NULL),('HCustomer','eth','eth@example.com','Ethan','ethPassword','Rivas',NULL,NULL,NULL),('HCustomer','Gabriel','Gabriel@example.com','Gabriel','GabrielPassword','Foster',NULL,NULL,NULL),('HCustomer','imanne','anne@example.com','Anne','imannePassword','Taylor',NULL,NULL,NULL),('HTeamedEmployee','jacob','jacob@example.com','Jacob','jacobPassword','Chan','Technician',1800,1),('HHeadDepartment','james','james@example.com','James','jamesPassword','Burns','Engineer',3000,NULL),('HCustomer','james96','james@example.com','James','james96Password','Parker',NULL,NULL,NULL),('HEmployee','john','john@example.com','John','johnPassword','Carter','CEO',20000,NULL),('HCustomer','john72','john72@example.com','John','john72Password','Branch',NULL,NULL,NULL),('HHeadDepartment','laura','laura@example.com','Laura','lauraPassword','Schmitt','Engineer',3000,NULL),('HCustomer','lisa','lisa@example.com','Lisa','lisaPassword','Smith',NULL,NULL,NULL),('HCustomer','lola','lola@example.com','Karola','lolaPassword','Leal',NULL,NULL,NULL),('HTeamedEmployee','lorry','lorry@example.com','Lorry','lorryPassword','Prenton','Technician',1800,1),('HEmployee','madeline','madeline@example.com','Madelaine','madelinePassword','Terrel','Technician',3000,NULL),('HCustomer','magicBob','magicbob@example.com','Bob','magicBobPassword','White',NULL,NULL,NULL),('HTeamedEmployee','maria','maria@example.com','Maria','mariaPassword','Morrison','Technician',1800,2),('HCustomer','Marianne','Marianne@example.com','Marianne','MariannePassword','Payne',NULL,NULL,NULL),('HTeamedEmployee','matt','matt@example.com','Matthew','mattPassword','Duncan','Technician',1800,2),('HCustomer','matty','matty@example.com','Matthew','mattyPassword','Simon',NULL,NULL,NULL),('HTeamedEmployee','michael','michael@example.com','Michael','michaelPassword','Woods','Technician',1800,3),('HCustomer','PaulPaul','paul@example.com','Paul','PaulPaulPassword','Scott',NULL,NULL,NULL),('HCustomer','Philip','Philip@example.com','Philip','PhilipPassword','Sanders',NULL,NULL,NULL),('HCustomer','ralph68','ralph68@example.com','Ralph','ralph68Password','Mayo',NULL,NULL,NULL),('HEmployee','randi','randi@example.com','Randi','randiPassword','Dickson','Janitor',1200,NULL),('HEmployee','richard','richard@example.com','Richard','richardPassword','Johnson','CTO',15000,NULL),('HHeadDepartment','rob','rob@example.com','Robert','robPassword','Kelley','Engineer',3000,NULL),('HTeamedEmployee','roy','roy@example.com','Roy','royPassword','Smith','Technician',1800,2),('HTeamedEmployee','ruth','ruth@example.com','Ruth','ruthPassword','Spencer','Technician',1800,3),('HCustomer','Sarah','Sarah@example.com','Sarah','SarahPassword','Washington',NULL,NULL,NULL),('HTeamedEmployee','seli','seli@example.com','Selinda','seliPassword','Reyna','Technician',1800,4),('HCustomer','soJenny','jenny@example.com','Jenny','soJennyPassword','Lingard',NULL,NULL,NULL),('HTeamedEmployee','susy','susy@example.com','Susan','susyPassword','Parks','Technician',2000,4),('HCustomer','timJ','tim@example.com','Tim','timJPassword','Jones',NULL,NULL,NULL),('HCustomer','Vince','Vince@example.com','Vincent','VincePassword','Ross',NULL,NULL,NULL);
...
-- Dump completed on 2019-11-07 11:51:51
