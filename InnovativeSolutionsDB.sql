...
INSERT INTO `users` VALUES ('HAdministrator','admin','admin@example.com','admin','adminPassword','admin','Administrator',10000,NULL,NULL),('HCustomer','adri','adri@example.com','Adrienne','adriPassword','Andrews',NULL,NULL,NULL,'s.Maria 7'),('HHeadDepartment','adrian','adrian@example.com','Adrian','adrianPassword','Robinson','Engineer',3000,NULL,NULL),('HEmployee','agatha','agatha@example.com','Agatha','agathaPassword','Lane','Janitor',1200,NULL,NULL),('HCustomer','amy','amy@example.com','Amy','amyPassword','Lowe',NULL,NULL,NULL,'v. Ferruccio Parri 15'),('HCustomer','anto83','anto83@example.com','Anthony','anto83Password','Griffin',NULL,NULL,NULL,'via DioTiSalvi, 20'),('HCustomer','betty','betty@example.com','Betty','bettyPassword','Jordan',NULL,NULL,NULL,'via Rome, 5'),('HTeamedEmployee','bob','bob@example.com','Robert','bobPassword','Caldwell','Technician',1800,1,NULL),('HCustomer','brad','brad@example.com','Bradley','bradPassword','Proctor',NULL,NULL,NULL,'via Marco Polo, 10'),('HTeamedEmployee','christopher','christopher@example.com','Christopher','christopherPassword','Austin','Technician',1800,4,NULL),('HCustomer','Dani','Dani@example.com','Danielle','DaniPassword','Johnson',NULL,NULL,NULL,'Piazza 11 settembre'),('HCustomer','david91','david91@example.com','David','david91Password','Baldwin',NULL,NULL,NULL,'Piazza napoleone, 10'),('HCustomer','Dia','Dia@example.com','Diana','DiaPassword','Williams',NULL,NULL,NULL,'via Vicolo Stretto 1'),('HCustomer','donny','donny@example.com','Donny','donnyPassword','Hudson',NULL,NULL,NULL,'via Bastione di gransasso, 12'),('HCustomer','eth','eth@example.com','Ethan','ethPassword','Rivas',NULL,NULL,NULL,'via Piazza Dante, 13'),('HCustomer','Gabriel','Gabriel@example.com','Gabriel','GabrielPassword','Foster',NULL,NULL,NULL,'via PonteCorvo, 102'),('HCustomer','imanne','anne@example.com','Anne','imannePassword','Taylor',NULL,NULL,NULL,'via Roma, 105'),('HTeamedEmployee','jacob','jacob@example.com','Jacob','jacobPassword','Chan','Technician',1800,1,NULL),('HHeadDepartment','james','james@example.com','James','jamesPassword','Burns','Engineer',3000,NULL,NULL),('HCustomer','james96','james@example.com','James','james96Password','Parker',NULL,NULL,NULL,'via Accademia, 24'),('HEmployee','john','john@example.com','John','johnPassword','Carter','CEO',20000,NULL,NULL),('HCustomer','john72','john72@example.com','John','john72Password','Branch',NULL,NULL,NULL,'via Largo Colombo, 205'),('HHeadDepartment','laura','laura@example.com','Laura','lauraPassword','Schmitt','Engineer',3000,NULL,NULL),('HCustomer','lisa','lisa@example.com','Lisa','lisaPassword','Smith',NULL,NULL,NULL,'piazza D\'azeglio , 1'),('HCustomer','lola','lola@example.com','Karola','lolaPassword','Leal',NULL,NULL,NULL,'piazzale Verdi, 5'),('HTeamedEmployee','lorry','lorry@example.com','Lorry','lorryPassword','Prenton','Technician',1800,1,NULL),('HEmployee','madeline','madeline@example.com','Madelaine','madelinePassword','Terrel','Technician',3000,NULL,NULL),('HCustomer','magicBob','magicbob@example.com','Bob','magicBobPassword','White',NULL,NULL,NULL,'via Parco della Vittoria, 60'),('HTeamedEmployee','maria','maria@example.com','Maria','mariaPassword','Morrison','Technician',1800,2,NULL),('HCustomer','Marianne','Marianne@example.com','Marianne','MariannePassword','Payne',NULL,NULL,NULL,'via Firenze, 14'),('HTeamedEmployee','matt','matt@example.com','Matthew','mattPassword','Duncan','Technician',1800,2,NULL),('HCustomer','matty','matty@example.com','Matthew','mattyPassword','Simon',NULL,NULL,NULL,'via Largo Lazzarino, 20'),('HTeamedEmployee','michael','michael@example.com','Michael','michaelPassword','Woods','Technician',1800,3,NULL),('HCustomer','PaulPaul','paul@example.com','Paul','PaulPaulPassword','Scott',NULL,NULL,NULL,'via Napolo 2'),('HCustomer','Philip','Philip@example.com','Philip','PhilipPassword','Sanders',NULL,NULL,NULL,'via Trenta 5'),('HCustomer','ralph68','ralph68@example.com','Ralph','ralph68Password','Mayo',NULL,NULL,NULL,'via Palerma  15'),('HEmployee','randi','randi@example.com','Randi','randiPassword','Dickson','Janitor',1200,NULL,NULL),('HEmployee','richard','richard@example.com','Richard','richardPassword','Johnson','CTO',15000,NULL,NULL),('HHeadDepartment','rob','rob@example.com','Robert','robPassword','Kelley','Engineer',3000,NULL,NULL),('HTeamedEmployee','roy','roy@example.com','Roy','royPassword','Smith','Technician',1800,2,NULL),('HTeamedEmployee','ruth','ruth@example.com','Ruth','ruthPassword','Spencer','Technician',1800,3,NULL),('HCustomer','Sarah','Sarah@example.com','Sarah','SarahPassword','Washington',NULL,NULL,NULL,'via Reggio Calabria 2'),('HTeamedEmployee','seli','seli@example.com','Selinda','seliPassword','Reyna','Technician',1800,4,NULL),('HCustomer','soJenny','jenny@example.com','Jenny','soJennyPassword','Lingard',NULL,NULL,NULL,'via Marco 2'),('HTeamedEmployee','susy','susy@example.com','Susan','susyPassword','Parks','Technician',2000,4,NULL),('HCustomer','timJ','tim@example.com','Tim','timJPassword','Jones',NULL,NULL,NULL,'via Luca Lazzarino 2'),('HCustomer','Vince','Vince@example.com','Vincent','VincePassword','Ross',NULL,NULL,NULL,'via DioTiSalvi ,69');
...
-- Dump completed on 2019-11-12 23:43:49
