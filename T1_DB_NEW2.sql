...
INSERT INTO `products` VALUES ('ISmartBand',7,'A smartband with fitness and medical tracking functions that can be connected via bluetooth to a smartphone',20,1),('ISmartLight',22,'A light bulb allowing remote control via Bluetooth',10,4),('ISmartLock',18,'A lock that can be installed into a door to allow it to be opened remotely or via a touchpad',45,2),('ISmartThermo',16,'A smart thermostat that allows remote readings and programming',55,1),('ISmartVideoBell',10,'A smart doorbell with an integrated display that initiates a video call when someone rings at the door',120,3);
...
-- Dump completed on 2019-12-05 15:39:07
